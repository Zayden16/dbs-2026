-- EXPLAIN FORMAT=TREE für die Projekt-Analytik (gleiche Logik wie 03_ev_ice_decision.sql).
-- In DBeaver ausführen und den Plan als Screenshot für den Bericht sichern.
-- Hinweis: Ohne `idx_ember_analytics_co2` erscheint unter `grid_intensity` typischerweise
--           „Table scan on e“ auf `stg_ember_electricity`.
USE ev_project;
