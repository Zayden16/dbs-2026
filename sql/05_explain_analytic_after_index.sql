-- Gleicher Plan wie `01_explain_analytic_baseline.sql`, nach Anlegen von `idx_ember_analytics_co2`.
-- Erwartung: „Index range scan on e using idx_ember_analytics_co2“ statt „Table scan on e“.
USE ev_project;
